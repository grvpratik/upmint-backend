...
const root_1 = __importStar(require("./exceptions/root"));
        ...
        try {
            ...
            if (error instanceof root_1.default) {
                ...
                if (error instanceof zod_1.ZodError) {
                    exception = new bad_request_1.BadRequestsException("validation error", root_1.ErrorCode.UNPROCESSABLE_ENTITY, error);
                }
                else {
